...
class MiniImagenet(Dataset):
    ...
    def create_batch(self, batchsz, mode):
        ...
        # with open('../data/flower_names.txt') as f:
        ...
        for selected_flower in flower_names:  # for each batch
            ...
            query_x = []
            candi_s0 = glob.glob('./data/patch/synthe/' + selected_flower + '*[02468].png')
            candi_s1 = glob.glob('./data/patch/synthe/' + selected_flower + '*[13579].png')
...
#             np.random.shuffle(selected_imgs_qry1)
            ...
            for k in range(1):
                query_x.append(sorted(glob.glob('./data/patch/natural/' + selected_flower + '*.png')))
